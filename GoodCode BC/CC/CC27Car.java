...
// Nothing changed here in CC 27. 
// It's the exact same code in the solution of CC26
import java.util.Arrays;
// a.
public class CC27Car {
   private String make;
   ...
   // b.
   // Constructor
   public CC27Car (String make, double price, int year, String color, String[] parts) { 
      this.make =  make;
      this.price = price;
      this.year  = year;
      this.color = color;
